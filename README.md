...
- [Serenity/JS HTML Report](https://serenity-js.github.io/serenity-js-cucumber-protractor-template/)

## Features

- Pre-configured **Serenity/JS** + **Cucumber** + **Protractor** + **TypeScript** setup
- Example feature files and step definitions demonstrating BDD web application testing
...
npm run test:wip        # executes only @wip-tagged scenarios
...
npm test -- --specs=features/super_calculator.feature
...
├── support/
│   └── *.ts                           # Support code (hooks, world, etc.)
