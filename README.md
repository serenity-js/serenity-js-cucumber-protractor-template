...
features/
├── super_calculator/
│   ├── calculations.feature               # Cucumber feature files
│   └── readme.md                          # Feature narrative
├── step_definitions/
│   └── super_calculator.steps.ts          # Cucumber step definitions
└── support/
...
├── index.ts                               # Test code exports
└── super-calculator/                      # Example calculator-related tasks
    ├── ConfirmCalculation.ts
    ├── EnterLeftSideOperand.ts
    ├── EnterRightSideOperand.ts
    ├── SelectOperator.ts
    ├── CalculationResult.ts
    └── ui/                                # Page objects and UI elements
        └── SuperCalculatorWidget.ts
